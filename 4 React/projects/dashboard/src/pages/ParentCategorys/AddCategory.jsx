    ...
    return (
        <div className=" min-h-screen p-4">
            <div className="w-full border border-[#ccc]  overflow-hidden  rounded-md  ">
                ...
                <h1 className="text-3xl bg-[#f1f5f9] p-3 font-semibold mb-6">Add Category</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 p-4 gap-6">
                    ...
                    <div>
                        ...
                        {/* Button */}
                        <button className="mt-6 bg-purple-700 hover:bg-purple-800 text-white text-2xl font-semibold px-8 py-3 rounded-xl">
                            Add Category
                        </button>
                    </div>
                    ...
                    <div className="md:col-span-2 space-y-8">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full p-2  border border-gray-300 rounded-lg px-5 text-xl outline-none focus:ring-2 focus:ring-purple-500"
                            />
                        </div>
