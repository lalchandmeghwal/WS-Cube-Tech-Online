...
import { closeLike } from "../redux/features/addToCartSlice";
...
const Header = () => {
    ...
    const showLike = useSelector(state => state.addToCart.showLike);
                ...
                <div className="max-w-7xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className=" flex gap-5 text-2xl   " >
                        ...
                        {like.length < 1 ? <FaHeart onClick={() => toast.warning('Please Like To Card')} /> :
                            <div onClick={() => dispatch(closeLike(true))} className=" cursor-pointer relative  " >
                                <FaHeart />
                                <span className=" text-lg text-center flex justify-center items-center bg-red-600 rounded-full  h-5 w-5 absolute -top-3 -right-3 text-white   " >
                                    {like.length}
                                </span>
