...
const CartList = ({ data }) => {
  ...
  const { image, name, description, price, brand, rating, id, qty } = data;

  const { removeToCartInItem, cart, setCart, changeQty } = useMyAaddToCart();
  ...
  return (<div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm  md:p-6">
    <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
      ...
      <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
        <h2 className="text-base font-medium text-gray-900 hover:underline ">
          {name} ${price}
        </h2>
        <p>{description}</p>
